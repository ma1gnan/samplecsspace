...
def main():
    ...
    # 1. Load the text file as an RDD
    # Replace with full path if necessary: "/Users/deborahmaignan/Desktop/CSC4760_Assign/people.csv"
    ...
    # 3. Parse the lines and map to key-value pairs: (gender, (age, 1))
